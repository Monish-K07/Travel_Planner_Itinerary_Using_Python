...
tourist_cities_india = [
    "Agra", "Amritsar", "Bangalore", "Chennai", "Cochin",
    "Darjeeling", "Delhi", "Goa", "Hyderabad", "Jaipur",
    "Jaisalmer", "Jodhpur", "Kanchipuram", "Kolkata", "Kodaikanal",
    "Leh Ladakh", "Mahabaleshwar", "Manali", "Munnar", "Mysore",
    "Ooty", "Pondicherry", "Puri", "Rishikesh", "Shimla",
...
def output_main(From, To, Type, Duration, Budget, TYPE, Ques):
    ...
    #print(load_lol)
    output, info, map = FINAL(From, To, Type, Duration, Budget, TYPE, Ques) 
...
def main():
    ...
    From = st.selectbox("From (Starting Point)", tourist_cities_india)
    To = st.selectbox("To (Destination)", tourist_cities_india)
